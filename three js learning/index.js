...
// then watch: https://youtu.be/lpAwHNgmvfc?si=9M14hB74G44DG9xV 
...
camera.position.z = 2; // move the camera back so we can view the scene
...
const material = new THREE.MeshBasicMaterial({ color: 0x00ff00}); // green color (this decides the material of the cube)
